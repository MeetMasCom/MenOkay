...
var routes_16 = __importDefault(require("./modules/package/routes"));
var routes_17 = __importDefault(require("./modules/admin/routes"));
var routes_18 = __importDefault(require("./modules/spam/routes"));
var routes_19 = __importDefault(require("./modules/notification/routes"));
var routes_20 = __importDefault(require("./modules/ads/routes"));
var routes_21 = __importDefault(require("./modules/balanceCompany/routes"));
var routes_22 = __importDefault(require("./modules/balanceUser/routes"));
var routes_23 = __importDefault(require("./modules/recordsTransactions/routes"));
var routes_24 = __importDefault(require("./modules/membership/routes"));
var routes_25 = __importDefault(require("./modules/chat/routes"));
var routes_26 = __importDefault(require("./modules/likePost/routes"));
var routes_27 = __importDefault(require("./modules/feedback/routes"));
...
var MainServer = /** @class */ (function () {
    ...
    MainServer.prototype.routes = function () {
        ...
        this.app.use(this.apiPaths.package, routes_16.default);
        this.app.use(this.apiPaths.ads, routes_20.default);
        this.app.use(this.apiPaths.like, routes_15.default);
        this.app.use(this.apiPaths.notification, routes_19.default);
        this.app.use(this.apiPaths.admin, routes_17.default);
        this.app.use(this.apiPaths.spam, routes_18.default);
        this.app.use(this.apiPaths.membership, routes_24.default);
        this.app.use(this.apiPaths.balanceCompany, routes_21.default);
        this.app.use(this.apiPaths.balanceUser, routes_22.default);
        this.app.use(this.apiPaths.recordsTransactions, routes_23.default);
        this.app.use(this.apiPaths.chat, routes_25.default);
        this.app.use(this.apiPaths.likeP, routes_26.default);
        this.app.use(this.apiPaths.feedback, routes_27.default);
