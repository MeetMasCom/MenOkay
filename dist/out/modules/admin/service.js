...
var AdminService = /** @class */ (function () {
    function AdminService() {
        ...
        this.login = function (params) { return __awaiter(_this, void 0, void 0, function () {
            var bcryptHelper, stringHelper, emailHelper, findUser, validPassword, userOpt, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        userOpt = _a.sent();
                        return [4 /*yield*/, emailHelper.loginUser(findUser.userName, userOpt.otp, findUser.email)];
                    case 4:
                        _a.sent();
