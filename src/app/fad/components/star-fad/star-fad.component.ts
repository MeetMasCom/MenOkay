...
@Component({
  selector: 'app-star-fad',
  templateUrl: './star-fad.component.html',
  styleUrls: ['./star-fad.component.css']
})
export class StarFadComponent {
  ...
  async onForm(event: any) {
    try {
      this.description = event.value.mdescription;
      this.name = event.value.mname;
